...
Bool_Username = Mobile.waitForElementPresent(findTestObject('LockScreen/UsernaneText'), 30)
...
if (Bool_Username == true) {
    ...
    Mobile.setText(findTestObject('LockScreen/NewPin/NewPin1'), '1', 0)
    ...
    Mobile.tap(findTestObject('LockScreen/Pin 1'), 0)

    WebUI.setText(findTestObject('LockScreen/Pin 1'), '1')

    Mobile.tap(findTestObject('LockScreen/Pin2'), 0)

    WebUI.setText(findTestObject('LockScreen/Pin2'), '2')

    Mobile.tap(findTestObject('LockScreen/Pin3'), 0)

    WebUI.setText(findTestObject('LockScreen/Pin3'), '3')

    Mobile.tap(findTestObject('LockScreen/Pin4'), 0)
