...
//Mobile.sendKeys(findTestObject('Add Contact/Search - Add Contact'), str_NewContact, FailureHandling.STOP_ON_FAILURE)
// Characters to choose from
//Mobile.sendKeys(findTestObject('TataMotars/SearchBox'), 'Test1 Test1', FailureHandling.STOP_ON_FAILURE)
// Scroll to an element by its XPath
//Mobile.scrollToElement(findTestObject('Influencer type'), 10)
// Scroll to a text on the screen
//Mobile.scrollToText('Influencer type', FailureHandling.STOP_ON_FAILURE)
import io.appium.java_client.TouchAction as TouchAction
import org.openqa.selenium.Dimension as Dimension

WebUI.callTestCase(findTestCase('CommenWorkflows/Login'), [('Str_URL') : 'C:\\Users\\sushil.gaikwad\\git\\EguruSmart1\\Application\\app-release (3).apk'
...
Mobile.setText(findTestObject('Primery Details/MobileNumber'), str_MobileNumber + randomInt, 0)
...
//Mobile.sendKeys(findTestObject('Primery Details/Enter InfluencerType'), Keys.chord(Keys.PAGE_DOWN, Keys.PAGE_DOWN))
// Get the size of the screen
//Dimension size = Mobile.getDriver().manage().window().getSize()
/* Set start and end coordinates for scrolling
int startX = 2
int startY = 2
int endX = 2
int endY = 4 */
// Adjust this value to control how much you want to scroll
/* Perform the scroll action
TouchAction touchAction = new TouchAction(Mobile.getDriver())
