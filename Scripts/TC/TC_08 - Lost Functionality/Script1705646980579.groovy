...
bool_Summary = Mobile.verifyElementExist(findTestObject('Lost and Non Lost Functionality/C0 Summary Text'), 30)

bool_Target = Mobile.verifyElementExist(findTestObject('Lost and Non Lost Functionality/Target text'), 30)
...
Mobile.tap(findTestObject('Lost and Non Lost Functionality/C0 Three Dots'), 0)
...
bool_ModelToLostTo = Mobile.verifyElementExist(findTestObject('Lost and Non Lost Functionality/ModelLostTo'), 0)
...
Mobile.tap(findTestObject('Lost and Non Lost Functionality/LTC RadioButton'), 0)

Mobile.tap(findTestObject('Lost and Non Lost Functionality/Reason for loss Field'), 0)

Mobile.setText(findTestObject('Lost and Non Lost Functionality/Reason for loss Field'), str_ReasonForLoss, 0)

Mobile.tap(findTestObject('MarkAsLost/ResonForLossTextNew'), 0)

Mobile.tap(findTestObject('Lost and Non Lost Functionality/Make lost to field'), 0)

Mobile.setText(findTestObject('Lost and Non Lost Functionality/Make lost to field'), str_MakeLossTo, 0)

Mobile.tap(findTestObject('MarkAsLost/MakeLostToTextNew'), 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('MarkAsLost/ModelLostToNew'), 0)

Mobile.setText(findTestObject('Home/ModelLostToText'), str_ModelLostTo, 0)

Mobile.hideKeyboard()

Mobile.tap(findTestObject('MarkAsLost/NewModelLostDropdown'), 0)
...
Mobile.verifyElementExist(findTestObject('Lost and Non Lost Functionality/LostCasesText'), 60)
